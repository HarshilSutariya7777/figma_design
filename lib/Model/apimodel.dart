...
//
//     final makupProduct = makupProductFromJson(jsonString);

import 'dart:convert';

List<MakupProduct> makupProductFromJson(String str) => List<MakupProduct>.from(
    json.decode(str).map((x) => MakupProduct.fromJson(x)));

String makupProductToJson(List<MakupProduct> data) =>
...
class MakupProduct {
  ...
  factory MakupProduct.fromJson(Map<String, dynamic> json) => MakupProduct(
        id: json["id"],
